...
AnnualCSV = r'K:\Streamflow\Final_Streamflow_Download\Annual_Summary_Flash_Flow.csv'

# Target File location for 5 year average Summary Stats

CSV_5yrStats = r'K:\Streamflow\Final_Streamflow_Download\Summary_5yr_Stats_Flash_Flow.csv'

# txt file that contains sitenames
siteNames = r'K:\Streamflow\Final_Streamflow_Download\WatershedList.txt'

# Open target CSV file to load in information

# loop through folder of CSVs

files = sorted(glob.glob(r'K:\Streamflow\Final_Streamflow_Download\WatershedsCSVs\*.csv'))
#########################################################################################
...
with open(AnnualCSV, 'w') as out_f:
    ...
    for element in files:
        try:
            ...
            years = (1990, 1991, 1992, 1993, 1994, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013)
            days = (365, 365, 366, 365, 365, 365, 366, 365, 365, 365, 366, 365, 365, 365, 366, 365, 365, 365, 366, 365)        
